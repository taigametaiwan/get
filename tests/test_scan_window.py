...
class ChuoiChienScanWindowTests(unittest.TestCase):
    def test_boundaries_and_unknown_live(self):
        rows = [
            ...
            {"url": "https://live03.chuoichientv.me/live/3/e-vs-f", "raw_title": "E vs F", "raw_time": "13:00 20/07", "card_text": "13:00 20/07"},
            {"url": "https://live03.chuoichientv.me/live/4/g-vs-h", "raw_title": "G vs H", "raw_time": "13:01 20/07", "card_text": "13:01 20/07"},
        ...
        self.assertEqual(rows[2]["minutes_to_kickoff"], 180)
...
class LuongSonScanWindowTests(unittest.TestCase):
    def test_url_datetime_window(self):
        rows = [
            ...
            {"url": "https://hygenie.io/truc-tiep/e-vs-f-vao-luc-1300-20-07-2026", "raw_title": "E vs F"},
            {"url": "https://hygenie.io/truc-tiep/g-vs-h-vao-luc-1301-20-07-2026", "raw_title": "G vs H"},
