...
class ParallelOrchestrationTests(unittest.TestCase):
    def test_five_sources_use_bounded_parallelism(self):
        started = {key: threading.Event() for key in ("chuoichien", "luongson", "gavang", "xoilac", "colatv")}
        ...
        def target():
            with patch.dict(os.environ, env, clear=True), \
                 ...
                 patch.object(orchestrator, "merge_sources", return_value={"selected_count": 1, "input_candidates": 5, "dropped_count": 4}), \
